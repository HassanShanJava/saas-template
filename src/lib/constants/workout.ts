...
export const workout_day_exercise_data = [
  {
    ...
    difficulty: "Beginner",
    sets: 1,
    seconds_per_set: [120, 105],
    repetitions_per_set: [],
    rest_between_set: [60, 45],
    distance: 0,
    speed: 0,
    met_id: 1,
    gif_url: "abc",
    ...
    thumbnail_male:
      "https://uploads.fitnfi.com/images/6f1cbec8-58bf-497a-8e9e-4c4a043ad968-image%2067.png",
    thumbnail_female: "",
    image_url_female: "",
    image_url_male: "",
    id: 51,
  ...
  },
  {
    ...
    difficulty: "Advance",
    sets: 2,
    seconds_per_set: [10, 15],
    repetitions_per_set: [],
    rest_between_set: [10, 40],
    distance: 12,
    speed: 12,
    met_id: 3,
    ...
    thumbnail_male:
      "https://uploads.fitnfi.com/images/f6f30a26-56c7-4189-8a43-0a65edd1f84b-VLAArrayNiteClouds_RGB.jpg",
    thumbnail_female: "",
