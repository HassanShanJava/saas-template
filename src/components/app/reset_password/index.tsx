      ...
      <div className="max-w-[1800px] mx-auto">
        {isLoading ? ( // Replace with your loading state condition
          ...
          <div className="grid grid-cols-3 mx-16 justify-between items-center h-dvh ">
            ...
            <Card className="col-span-2 lg:col-span-1 mx-auto bg-transparent bg-opacity-10  backdrop-blur-sm custom-gradient-bg rounded-3xl border-checkboxborder shadow-lg p-2">
              <CardHeader>
                <CardTitle>
