...
export default function Checkout({
  ...
  const paymentsTotal = watcher.payments.reduce(
  ...
  const addPaymentMethod = (
    ...
    setPayments((prevPayments) => {
      const updatedPayments = prevPayments.some(
        (payment) => payment.payment_method_id === id
      )
  ...
  const placeOrder = async () => {
    ...
    if (
      watcher.payments.some((item: paymentItem) => item.amount == undefined)
    ) {
      toast({
        variant: "destructive",
          ...
          <div className="bg-white  p-6 rounded-lg">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-400">
                Email: {watcher.member_email}
              </p>
              <p className="text-sm text-gray-400">
                Address: {watcher.member_address}
              </p>
              <p></p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="font-bold">
                  {roundToTwoDecimals(watcher.subtotal)}
                </div>
              </div>
              <div className="flex justify-between items-center">
                <div>Discount</div>
                <div className="font-bold">
                  {formatToPKR(
                    watcher.discount_amt > 0
                      ? -Number(watcher.discount_amt)
                      : watcher.discount_amt
                  )}
                </div>
              </div>
              <div className="flex justify-between items-center">
                ...
                {enabledPayments?.map((method: any) => (
                  ...
                  >
                    <Checkbox
                      ...
                      disabled={
                        invoiceId != null ||
                        (isTotalReached && !selectedMethods[method.name])
                      }
