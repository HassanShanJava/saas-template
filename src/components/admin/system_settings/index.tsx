	...
	return (
		<div className="bg-[#F8F9FA]">
			<div className="h-full pt-10 pb-5 pl-5">
				...
				<div className="flex px-2">
					...
					<div className="flex justify-center items-center text-gray-400">
						...
						<Link to="/admin/dashboard">
							<i className="fa-regular fa-folder pr-1 text-gray-300"></i>System Setting
						</Link>
					</div>
			...
			<div className="m-4 rounded-3xl px-8 py-6 flex bg-white justify-between">
				<div className="w-full">
					<div className="pt-5 pb-10 space-y-3">
						...
						<p className="text-textgray text-sm w-2/3">This company information is publicly available to your clients and to our millions of Virtuagym users to learn about your business.</p>
					</div> 
					<div className="flex w-full space-x-10">
						...
						<div className="flex-auto space-y-1">
							...
							<div className="py-2">
								<MapContainer center={[51.505, -0.09]} zoom={13} scrollWheelZoom={false} className="h-32">
									<TileLayer
							...
							<div className="flex text-gray-500 space-x-10">
								<div className="flex-1 space-y-3">
									...
									<div>
										...
										<Input type="text" placeholder="CS-26147-ACCESS-vrwzgdRxUaP.." />
									</div>
									<div>
			...
			<div className="m-4 rounded-3xl px-8 py-6 flex bg-white justify-between">
				<div className="w-full">
					<div className="pt-5 pb-10 space-y-3">
						<h2 className="text-lg font-bold">Contracts agreements and conditions</h2>
						<p className="text-textgray text-sm w-2/3">Manage and personalize the legal text shown on your contracts. Variables you can use: PAYMENT_METHOD</p>
					</div> 
					<div className="flex">
						...
						<div className="flex flex-1 items-end justify-end space-x-3">
							<span className="flex-auto text-textprimary text-right">+ Add a new field</span>
							<Button className="w-[15rem] text-black">Save & update agreements</Button>
						</div>
					</div>
				</div>
			</div>
